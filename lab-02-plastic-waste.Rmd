...
```{r plastic_waste_per_cap, eval=TRUE}
library(ggplot2)
ggplot(data = plastic_waste, mapping = aes(x = plastic_waste_per_cap, color = continent, fill = continent)) + geom_histogram (alpha = 0.3)
